...
%We set a significance level of $0.05$ to reject the null hypothesis.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lcccc}
    ...
    %IDP\_SAS\_CONSISTENCY\_FLAG\_MASS & mandatory & boolean & bit & true/false \\
    %IDP\_SAS\_CONSISTENCY\_FLAG\_RADIUS & mandatory & boolean & bit & true/false \\
    %IDP\_SAS\_CONSISTENCY\_FLAG\_AGE & mandatory & boolean & bit & true/false \\
    \bottomrule
  \end{tabular}
\end{table}
...
%The complete list of seismic inputs needs to be added. 
